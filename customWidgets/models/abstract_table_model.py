...
class AbstractTableModel(QAbstractTableModel):
    def __init__(self, file_clicked):
        ...
        self.final_data = SerialFileHandler(
    ...
    def print_real_data(self):
        for d in self.final_data.get_all():
            print(str(d))
    ...
    def print_unpacked_data(self):
        print("Data path: {}, Metadata path: {}, databaseType: {}".format(
            self.original_data_filepath, self.original_metadata_filepath, self.database_type))
